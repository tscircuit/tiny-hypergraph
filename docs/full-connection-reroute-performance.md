...
Stacked on PR #203 (`feat/full-connection-reroute`). Measurements were prepared
from `origin/main` (`ae00a96`) with PR #203 applied; this PR contains only the
optimization changes and inherits the original rerouting tests and snapshot.
