...
export default function Cm5ioBusRouterBus1Page() {
  ...
  return (
    <div className="flex h-screen flex-col gap-3 p-3">
      <div className="rounded border border-slate-300 bg-white p-3 text-sm text-slate-700">
        CM5IO `bus1` routed with the fixed-centerline bus solver. The solver
        solves the middle trace first, then routes the remaining traces against
        that centerline using the bus spacing penalty and a centerline
        intersection veto.
      </div>
