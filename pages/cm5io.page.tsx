  ...
  return (
    <div className="flex h-screen flex-col gap-3 p-3">
      <div className="rounded border border-slate-300 bg-white p-3 text-sm text-slate-700">
        ...
        completion from the best partial, alternating hotspot cleanup, then
        repeated representative-corridor bus repairs that hand the board back
        to the local hotspot passes between structural moves.
      </div>
