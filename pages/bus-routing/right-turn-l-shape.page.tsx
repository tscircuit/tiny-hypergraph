...
import { busRightTurnLShapeFixture } from "../../tests/fixtures/bus-right-turn-l-shape.fixture"
...
export default function BusRoutingRightTurnLShapePage() {
  return (
      ...
      <div className="grid min-h-0 flex-1 gap-3 lg:grid-cols-2">
        <section className="flex min-h-0 flex-col overflow-hidden rounded border border-slate-300 bg-white">
          ...
          <div className="min-h-0 flex-1">
            <Debugger
              serializedHyperGraph={busRightTurnLShapeFixture}
